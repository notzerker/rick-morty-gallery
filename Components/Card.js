...
const Card = ({ character, close, visible }) => {
  const Trait = ({ desc, trait }) => {
    return (
      <div className="flex flex-col rounded-lg w-44 h-12 bg-gray-200 items-start justify-center px-4 shadow-lg">
  ...
  return (
    <div
      ...
      onClick={close}
    >
      <div className="w-[64rem] h-[30rem] rounded-lg bg-gray-300 flex flex-row items-center justify-between shadow-lg relative">
